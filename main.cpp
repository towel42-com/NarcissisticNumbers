...
int main( int argc, char ** argv )
{
    ...
    std::cout << "=============================================\n";
    std::cout << "Fastest: " << std::get< 2 >(*(minMax.first)) << " - " << getTimeString(std::get< 1 >(*(minMax.first)), true, true) << std::endl;
    std::cout << "Slowest: " << std::get< 2 >(*(minMax.second)) << " - " << getTimeString(std::get< 1 >(*(minMax.second)), true, true) << std::endl;
    std::cout << "=============================================\n";
    for (auto&& curr : runTimes)
    {
        std::cout << "Fastest: " << std::get< 2 >( curr ) << " - " << getTimeString(std::get< 1 >( curr ), true, true) << std::endl;
    }
